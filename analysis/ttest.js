...
console.log('  disease mean chol    : ' + diseaseMean.toFixed(2) + ' mg/dl');
console.log('  healthy mean chol    : ' + healthyMean.toFixed(2) + ' mg/dl');

console.log('  difference           : ' +(diseaseMean - healthyMean).toFixed(2) +' mg/dl\n');
...
if (result.ci) { console.log('  95% CI               : [ ' +result.ci[0].toFixed(2) +',  ' +result.ci[1].toFixed(2) +' ]');}
